...
?>
	...
	<!-- <footer id="colophon" class="site-footer"> -->
		<!-- <div class="site-info">
			<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'coach' ) ); ?>">
				<?php
			...
			<span class="sep"> | </span>
				...
				// printf( esc_html__( 'Theme: %1$s by %2$s.', 'coach' ), 'coach', '<a href="http://underscores.me/">Underscores.me</a>' );
				?>
		</div> -->
		<!-- .site-info -->
	<!-- </footer> -->
          ...
          <div class="row-footer">
                ...
                <div class="footer-contact">
                  <ul class="footer-info">
                    <li class="item">
                      ...
                      <a target="_blank" href="https://www.google.com/maps?q=123Yarranst,Punchbowl,NSW2196,Australia">
                    ...
                    <li class="item">
                      ...
                      <a href="mailto:support@example.com">info@healthyfamilyshop.com</a>
                    </li>
                  </ul>
            ...
            <div class="footer-inner-wrap footer-col-block s2">
              ...
              <div class="tf-collapse-content">
                <div class="footer-newsletter">
                  <p>
                    Zapraszamy do rejestracji, aby otrzymywać najnowsze informacje, oferty i wydarzenia związane z naszą działalnością. 
					Obiecujemy nie spamować Twojej skrzynki odbiorczej.
                  </p>
            ...
            <div class="footer-inner-wrap s3">
              <!-- <div class="footer-col-block inner-col">
                <div class="footer-heading footer-heading-mobile text-xl fw-medium">O mnie</div>
                <div class="tf-collapse-content">
                  <ul class="footer-menu-list">
                    <li>
                      <a href="about-us.html">O mnie</a>
                    </li>
                    <li>
                      <a href="contact-us.html">Kontakt</a>
                    </li>
                    <li>
                      <a href="store-location.html">Sklep</a>
                    </li>
                    <li>
                      <a href="about-us.html">Moja historia</a>
                    </li>
                  </ul>
                </div>
              </div> -->
				...
				<div class="footer-heading footer-heading-mobile text-xl fw-medium">O mnie</div>
					<div class="tf-collapse-content">
							...
							wp_nav_menu( array(
								...
								'walker'         => new Coach_Footer_Walker(),
							) );
							?>
					</div>
				</div>
